...
function loadStatsPage() {
    ...
    for(var rNum = 2; rNum < table.rows.length; rNum++) {
        
        var row = table.rows[rNum];

        var hScore = row.cells[2].innerHTML;
        var oScore = row.cells[3].innerHTML;
    ...
    var alterW = document.getElementById("wins");
    alterW.innerHTML += w;

    var alterL = document.getElementById("losses");
    alterL.innerHTML += l;
}
/*
...
function switchPlayers(playerNum){
   ...
   var r =Math.floor(players[playerNum].receiving_yards/players[playerNum].games_played);
